...
Il progetto è hostato su Firebase all'indirizzo
https://uncake-1a2f6.firebaseapp.com


- Creato proetto con create-react-app
- Installato libreria Firebase con npm install -S firebase
- Installato tool per il deploy con npm install -g firebase-tools
